/* this file is just static json data. it's big, so it's isolated in this file */


// <editor-fold defaultstate="collapsed" desc="-- LANGUAGESTRINGSDATA  --">
export const LANGUAGESTRINGSDATA = [{
  id: "af-ZA",
...
// <editor-fold defaultstate="collapsed" desc="-- DEFAULT_VOICES_DATA  --">

// todo: trimmed down to just english until a key is available and the rest can be fetched?
// default loaded from https://texttospeech.googleapis.com/v1beta1/voices?key=
// You probably should be using VoicesList
export const DEFAULT_VOICES_DATA = {
  "voices": [
    {
      "languageCodes": [
        "de-DE"
